...
export default function DashboardHRD() {
  ...
  useEffect(() => {
    ...
    fetch('https://jobportal-api-zebb.onrender.com/api/dashboard/stats', { headers: { 'Authorization': `Bearer ${token}` } })
      .then(r => r.json()).then(setStats).catch(console.error)

    fetch('https://jobportal-api-zebb.onrender.com/api/my-interviews', { headers: { 'Authorization': `Bearer ${token}` } })
  ...
  const cancelInterview = async (appId) => {
    await fetch(`https://jobportal-api-zebb.onrender.com/api/applications/${appId}/status`, {
      method: 'PUT',
  ...
  return (
    <>
      <div className="hrd-root">
        ...
        <aside className={`hrd-sidebar ${isSidebarOpen ? "sidebar-open" : ""}`}>
